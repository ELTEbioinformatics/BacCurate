...
class SelectionSchema:
    ...
    def evaluate(self, *, attribute: str, value: str) -> SelectionDecision:
        ...
        for target in EXTRACTION_TARGET_ORDER:
            ...
            for discovery in target_rules.discoveries:
                if discovery.matches(normalized_attribute):
                    ...
                    break
        return SelectionDecision(attribute, value, tuple(matches), tuple(events))
