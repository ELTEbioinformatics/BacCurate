...
DEFAULT_GENBANK_ASSEMBLY_SNAPSHOT_MANIFEST = CONFIG_DIR / "assembly_summary_genbank_snapshot.yaml"
DEFAULT_REFSEQ_ASSEMBLY_SNAPSHOT_MANIFEST = CONFIG_DIR / "assembly_summary_refseq_snapshot.yaml"
...
DEFAULT_ISOLATION_SOURCE_ONTOLOGY_DIRECTORY = REFERENCE_DIR / "ontology"
DEFAULT_GEO_LOC_LIST = REFERENCE_DIR / "geo_loc_list.txt"
DEFAULT_MAP_UNIT_BOUNDARIES = REFERENCE_DIR / "ne_10m_admin_0_map_units.geojson"
