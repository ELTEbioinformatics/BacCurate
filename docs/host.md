...
|-------------|--------------------------------------------------------------|
| `accession` | Record ID                                                    |
| `host_attr` | `\|\|`-separated attribute names                             |
| `host_val`  | `\|\|`-separated values, paired by position with `host_attr` |
...
| `host_attr`           | Standardized input attribute(s)                                                   |
| `host_val`            | Standardized input value(s)                                                       |
